...
describe('resolveLeverage', () => {
  ...
  it('DEFAULT_LEVERAGE_CONFIG matches the RT-AUDIT-001-confirmed design table (BTC/ETH=20x, SOL/HYPE/XRP=10x)', () => {
    expect(DEFAULT_LEVERAGE_CONFIG).toEqual({
      fourCoinLeverage: { BTCUSDT: 20, ETHUSDT: 20, SOLUSDT: 10, HYPEUSDT: 10, XRPUSDT: 10 },
    });
  });
});
