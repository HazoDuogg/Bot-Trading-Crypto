...
import { createAtrTracker } from '../../backtest/engine/noTradeZone/atr.js';
import type { Candle } from '../../backtest/engine/noTradeZone/types.js';
import { evaluateBreakoutStrength } from '../archive/legacy-5coin-entry/breakoutStrength.js';
import { detectCompressionSeries, type CompressionResult } from '../archive/legacy-5coin-entry/compression.js';
import { calculateEma } from '../archive/legacy-5coin-entry/emaTrendFilter.js';
import { evaluateEmaTrendH1, type EmaTrendSnapshot } from '../archive/legacy-5coin-entry/emaTrendFilterH1.js';
import { aggregateM15ToClosedH1 } from '../../core/structure/h1Aggregator.js';
import { M15_CANDLE_DURATION_MS } from '../../backtest/engine/intrabarExecution.js';
import { calculateExecutionCosts } from '../../backtest/engine/costModel.js';
