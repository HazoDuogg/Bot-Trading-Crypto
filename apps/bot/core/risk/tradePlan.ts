import { BINANCE_USDM_VIP0_BNB_DISCOUNT_MAKER_FEE_RATE } from '../../backtest/engine/costModel.js';
import type { M1RetestWindowResult } from '../../research/archive/legacy-5coin-entry/retestEntry.js';
...
export function createTradePlan(input: TradePlanInput): TradePlan | null {
  ...
  const invalidationBoundary = input.signal.direction === 'BULL' ? baseZone.low : baseZone.high;
