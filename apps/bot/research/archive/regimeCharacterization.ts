...
import { createDefaultStrategyAdapter } from './legacy-5coin-entry/nukidaFsm.js';
import { computeStrategyFingerprint } from '../../backtest/engine/fingerprint.js';
import type { SetupSignal } from './legacy-5coin-entry/setupDetectorA.js';
import {
  DEFAULT_COIN_BACKTEST_CONFIG,
  defaultDataGate,
  loadM15CandlesBetween,
} from '../../backtest/runners/runNukidaBacktest.js';
import {
  M15_MS,
  TICKET_020_STRATEGY_FINGERPRINT,
  buildRollingWindows,
  type RollingWindow,
} from '../../backtest/runners/runNukidaWalkForwardRolling.js';
